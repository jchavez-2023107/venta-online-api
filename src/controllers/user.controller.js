 ...
 * Permite actualizar datos personales y, opcionalmente, la contraseña (si no se usa el endpoint especial).
 * Nota: No se permiten cambios en email ni rol.
 */
export const updateUserProfile = async (req, res) => {
  try {
    // Extraemos los campos a actualizar, incluyendo username y email
    const { name, surname, username, email, phone, password, preferences } =
      req.body;
